...
; CHECK-NEXT:    adr r5, .LCPI0_1
; CHECK-NEXT:    add.w r4, r2, r3, lsl #2
; CHECK-NEXT:    add.w r6, r1, r3, lsl #2
; CHECK-NEXT:    add.w r9, r0, r3, lsl #2
; CHECK-NEXT:    vldrw.u32 q1, [r5]
; CHECK-NEXT:  .LBB0_4: @ %vector.body
; CHECK-NEXT:    @ =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ldrd r5, r11, [r0], #8
; CHECK-NEXT:    mov.w r3, #-1
; CHECK-NEXT:    ldrd r7, r12, [r1], #8
; CHECK-NEXT:    mov.w r10, #0
; CHECK-NEXT:    smull r8, r5, r7, r5
; CHECK-NEXT:    asrl r8, r5, #31
; CHECK-NEXT:    rsbs.w r7, r8, #-2147483648
; CHECK-NEXT:    sbcs.w r7, r3, r5
; CHECK-NEXT:    smull r12, r3, r12, r11
; CHECK-NEXT:    csetm r7, lt
; CHECK-NEXT:    bfi r10, r7, #0, #8
; CHECK-NEXT:    asrl r12, r3, #31
; CHECK-NEXT:    rsbs.w r7, r12, #-2147483648
; CHECK-NEXT:    vmov q2[2], q2[0], r8, r12
; CHECK-NEXT:    mov.w r7, #-1
; CHECK-NEXT:    vmov q2[3], q2[1], r5, r3
; CHECK-NEXT:    sbcs r7, r3
; CHECK-NEXT:    mvn r12, #-2147483648
; CHECK-NEXT:    csetm r7, lt
; CHECK-NEXT:    bfi r10, r7, #8, #8
; CHECK-NEXT:    vmsr p0, r10
...
; CHECK-NEXT:    @ =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ldr r3, [r9], #4
; CHECK-NEXT:    ldr r7, [r6], #4
; CHECK-NEXT:    smull r0, r3, r7, r3
; CHECK-NEXT:    asrl r0, r3, #31
; CHECK-NEXT:    subs r7, r1, r0
; CHECK-NEXT:    sbcs.w r7, r5, r3
; CHECK-NEXT:    csel r0, r0, r1, lt
; CHECK-NEXT:    csel r3, r3, r5, lt
; CHECK-NEXT:    subs r7, r0, r2
...
; CHECK-NEXT:    movs r6, #1
; CHECK-NEXT:    vldrw.u32 q0, [r5]
; CHECK-NEXT:    adr r5, .LCPI1_1
; CHECK-NEXT:    add.w lr, r6, r7, lsr #2
; CHECK-NEXT:    str r3, [sp] @ 4-byte Spill
; CHECK-NEXT:    add.w r9, r2, r3, lsl #2
; CHECK-NEXT:    add.w r10, r4, r3, lsl #2
; CHECK-NEXT:    add.w r12, r0, r3, lsl #2
; CHECK-NEXT:    vldrw.u32 q1, [r5]
; CHECK-NEXT:  .LBB1_4: @ %vector.body
; CHECK-NEXT:    @ =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    vldrw.u32 q3, [r4], #16
...
; CHECK-NEXT:    bfi r3, r4, #0, #8
; CHECK-NEXT:    vmov r4, r11, d13
; CHECK-NEXT:    asrl r4, r11, #31
; CHECK-NEXT:    rsbs.w r2, r4, #-2147483648
; CHECK-NEXT:    vmov q4[2], q4[0], r6, r4
; CHECK-NEXT:    sbcs.w r2, r7, r11
; CHECK-NEXT:    vmov q4[3], q4[1], r5, r11
...
; CHECK-NEXT:    smull r8, r5, r3, r2
; CHECK-NEXT:    mov r3, r1
; CHECK-NEXT:    asrl r8, r5, #31
; CHECK-NEXT:    rsbs.w r2, r8, #-2147483648
; CHECK-NEXT:    sbcs.w r2, r7, r5
; CHECK-NEXT:    csetm r2, lt
; CHECK-NEXT:    bfi r3, r2, #0, #8
; CHECK-NEXT:    vmov r2, s10
; CHECK-NEXT:    smull r2, r7, r4, r2
; CHECK-NEXT:    asrl r2, r7, #31
; CHECK-NEXT:    rsbs.w r4, r2, #-2147483648
; CHECK-NEXT:    vmov q2[2], q2[0], r8, r2
; CHECK-NEXT:    sbcs.w r4, r6, r7
; CHECK-NEXT:    vmov q2[3], q2[1], r5, r7
; CHECK-NEXT:    csetm r4, lt
; CHECK-NEXT:    bfi r3, r4, #8, #8
; CHECK-NEXT:    vmsr p0, r3
; CHECK-NEXT:    vpsel q2, q2, q0
...
; CHECK-NEXT:    vdup.32 q4, r11
; CHECK-NEXT:    mov r4, r12
; CHECK-NEXT:    add.w r11, r11, #4
...
; CHECK-NEXT:    vmov q0[2], q0[0], r10, r6
; CHECK-NEXT:    sbcs.w r5, r8, r3
; CHECK-NEXT:    vmov q0[3], q0[1], r7, r3
; CHECK-NEXT:    csetm r5, lt
; CHECK-NEXT:    bfi r4, r5, #8, #8
; CHECK-NEXT:    vmsr p0, r4
; CHECK-NEXT:    vpsel q0, q0, q2
; CHECK-NEXT:    vmov r3, r4, d0
; CHECK-NEXT:    subs.w r3, r3, r9
...
; CHECK-NEXT:    add.w r11, r1, r3, lsl #2
; CHECK-NEXT:    str r3, [sp, #8] @ 4-byte Spill
; CHECK-NEXT:    add.w r3, r0, r3, lsl #2
; CHECK-NEXT:    add.w lr, r6, r7, lsr #2
; CHECK-NEXT:    str r3, [sp, #4] @ 4-byte Spill
; CHECK-NEXT:    vmov.i64 q0, #0xffffffff
...
; CHECK-NEXT:    bfi r4, r3, #0, #8
; CHECK-NEXT:    vmov r6, r3, d9
; CHECK-NEXT:    lsrl r6, r3, #31
; CHECK-NEXT:    subs.w r7, r6, #-1
; CHECK-NEXT:    vmov q1[2], q1[0], r8, r6
...
; CHECK-NEXT:  @ %bb.5: @ %middle.block
; CHECK-NEXT:    ldrd r12, r3, [sp, #8] @ 8-byte Folded Reload
